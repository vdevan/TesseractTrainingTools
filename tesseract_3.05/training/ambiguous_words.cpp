...
int main(int argc, char** argv) {
  ...
  FILE* input_file; //Added on 6th April - Vasu
  fopen_s(&input_file,input_file_str, "rb"); //Added on 6th April - Vasu
  
  //FILE *input_file = fopen(input_file_str, "rb"); //Commented on 6th April - Vasu
  if (input_file == NULL) {
