...
class CHAR_FRAGMENT {
 public:
  ...
  inline void set_unichar(const char *uch) {
	 strncpy_s(this->unichar, UNICHAR_LEN, uch, UNICHAR_LEN);//Added on 6th April - Vasu
	//strncpy(this->unichar, uch, UNICHAR_LEN); //Commented on 6th April - Vasu 
...
class UNICHARSET {
 public:
  ...
  bool save_to_file(const char * const filename) const {
	  ...
	  FILE* file; //Added on 6th April - Vasu
	  fopen_s(&file, filename, "w+b"); //Added on 6th April - Vasu
    
	//FILE* file = fopen(filename, "w+b"); //Commented on 6th April - Vasu
  ...
  bool load_from_file(const char* const filename, bool skip_fragments) {
	  ...
	  FILE* file; //Added on 6th April - Vasu
	  fopen_s(&file, filename, "rb"); //Added on 6th April - Vasu
	  
	  //FILE* file = fopen(filename, "rb"); //Commented on 6th April - Vasu
    if (file == NULL) return false;
